    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'view',
                    'url'  => 'admin/student-image',
                    'icon' => 'far fa-fw fa-user',
                ],
                [
                    'text' => 'create',
                    'url'  => 'admin/student-image-create',
                    'icon' => 'far fa-fw fa-user',
                ],
            ],
        ],
        ...
        [
            'text'       => 'Problems',
            'icon_color' => 'red',
            'url'        => 'admin/problem-view',
        ],
        [
            'text'       => 'Teacher and Subject',
            'icon_color' => 'red',
            'url'        => 'admin/teacher-subject',
        ],
        [
            'text'  => 'Teacher Create alt',
            'icon' => 'far fa-fw fa-user',
            'url'   => 'admin/teacher-create',
        ],
        [
            'text'  => 'Subject Create repeater',
            'icon' => 'far fa-fw fa-user',
            'url'   => 'admin/subject-create',
        ],
